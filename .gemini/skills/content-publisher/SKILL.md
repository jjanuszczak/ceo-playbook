...
1.  **Track & Branch:**
    ...
    -   Command: `python3 .gemini/skills/github-issue-manager/scripts/manage_issue.py "Publish: [Article Title]" "Publishing [Article Title]" --type enhancement`

2.  **Transform Content:**
    -   On the new branch, run the publication script to update the frontmatter and timestamp.
    -   Command: `python3 .gemini/skills/content-publisher/scripts/manage_publication.py --publish "[Fuzzy Title or Slug]"`

3.  **Submit for Review:**
    -   Commit and push changes using `git-workflow-lifecycle`.
    -   Command: `python3 .gemini/skills/git-workflow-lifecycle/scripts/submit_work.py --message "chore: publish [slug]"`
...
2.  **Transform Content:**
    -   Command: `python3 .gemini/skills/content-publisher/scripts/manage_publication.py --unpublish "[Fuzzy Title or Slug]"`
...
<AVAILABLE_RESOURCES>
-   **Evaluation Runner:** `.gemini/skills/content-publisher/evals/runner.py`
</AVAILABLE_RESOURCES>

---
title: "Why the Yield Curve is the Pulse of Every Bank"
date: 2026-03-11
summary: "A deep dive into the 'gravitational constant' of finance: the yield curve. Former UBX CEO John Januszczak explains how interest rate spreads drive banking physics and why inversions stall the engine of innovation."
description: "Understanding the yield curve as the heartbeat of banking. This Lab entry explores Net Interest Margin (NIM), the mechanics of curve inversions, and why the shape of the yield curve dictates the flow of capital to fintech and MSMEs."
draft: false
categories:
  - Fintech
tags:
...
Explore the **[Interactive Yield Curve Model](/yield-curve/)** to see how the curve shifts over time and its impact on banking physics.
{{< /alert >}}
...
The fundamental business model of banking hasn't changed in centuries: **Net Interest Margin (NIM).** As a bank, you borrow money from depositors (short-term) and lend it out to homeowners or businesses (long-term). In a **Normal Yield Curve**, long-term rates are higher than short-term rates. This "upward slope" is the bank's profit engine. You pay out 2% on savings and charge 6% on a mortgage. That 4% "spread" is what pays for the developers, the servers, and the risk.

## When the Gravity Flips: The Inversion

When the curve **inverts**—meaning short-term rates are higher than long-term rates—the engine starts to stall.
...
When I was at UBX, we focused on financial inclusion and helping MSMEs (Micro, Small, and Medium Enterprises). An inverted curve is the enemy of inclusion.
...
*For more technical deep dives into the mechanics of finance and digital transformation, check out the rest of the [**Engine Room**]({{< relref "/lab" >}}) series.*

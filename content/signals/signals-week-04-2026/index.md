...
{{< x-article user="alex_prompter" id="2014254464870555953" title="LLMs Don't Reason, They React" image="https://pbs.twimg.com/media/G_QRwslbkAAfPCu?format=jpg&name=small" >}}
...
{{< x user="mert" id="2014690824794341814" >}}
...
{{< x-article user="colossusmag" id="2013234622738350496" title="The Silicon Valley Canon" image="https://pbs.twimg.com/media/G_BxyXYWMAA3A-k?format=jpg&name=small" >}}
...
{{< x user="mntruell" id="2011562194006393106" >}}
...
{{< x-article user="shanaka86" id="2013800888616230974" title="The Yen Carry Bomb" image="https://pbs.twimg.com/media/G_J1OylbkAAR5NX?format=jpg&name=small" >}}
...
{{< figure
  src="this-week-in-stratechery.png"
  alt="Netflix and TSMC in Stratechery"
>}}

**Summary:** [Ben Thompson analyzes](https://stratechery.com/2026/netflix-luka-and-life-in-la-la-land/) Netflix's dominance and the physical constraints of chip production (TSMC) for the AI boom.
...
{{< figure
  src="peter-steinberger.png"
  alt="Creator of Clawdbot"
>}}

[Peter Steinberger](https://steipete.me/) is the creator is Clawdbot, an open-source, self-hosted, and privacy-focused personal AI assistant designed to run 24/7 on your own hardware (laptop, server, etc.). It is behind the current trend amongst tech fans of using the M4 Mac Mini to host it.
...
{{< figure
  src="american-icon.png"
  alt="American Icon"
>}}

**Summary:** Alan Mulally’s philosophy that turned around Ford. *(From [American Icon](https://www.amazon.com/American-Icon-Mulally-Fight-Company/dp/0307886069))*
...
{{< figure
  src="how-to-measure-anything.png"
  alt="How to Measure Anything"
>}}

**Summary:** Redefining measurement not as finding an exact number, but as reducing the margin of error. *(From [How to Measure Anything](https://www.amazon.com/How-Measure-Anything-Intangibles-Business/dp/1118539273))*
...
{{< figure
  src="work-the-system.png"
  alt="Work the System"
>}}

**Summary:** A classic reminder that speed and momentum often outweigh precision. *(From [Work the System](https://www.amazon.com/Work-System-Mechanics-Working-Revised/dp/160832253X))*

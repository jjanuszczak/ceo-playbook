---
title: "From Fintech to Energy Abundance: Unpacking My Latest Conversation on Founders Only"
date: 2026-05-26
draft: false
summary: "A deep dive into the transition from building UBX to driving energy abundance in the Philippines with 1882 Energy Ventures."
description: "John Januszczak returns to the Founders Only podcast to discuss succession at UBX, the non-negotiable need for energy abundance, and the evolution of C-Suite leadership in a hardware-centric world."
categories:
  - "Venture Building"
tags:
  - "venture-building"
...
mentions:
  - name: "UBX Philippines"
    url: "https://ubx.ph/"
  - name: "1882 Energy Ventures"
    url: "https://1882energyventures.com"
  - name: "Aboitiz Equity Ventures"
    url: "https://aboitiz.com"
  - name: "Voltai"
    url: "https://voltai.ph"
  - name: "Solviva"
    url: "https://www.solvivaenergy.com"
citations:
  - title: "From Fintech to Energy Abundance | Founders Only Podcast"
    url: "https://www.youtube.com/watch?v=umXfROcu8FI"
  - title: "Founders Only Podcast Channel"
    url: "https://www.youtube.com/@foundersonlypodcast"
showReadingTime: true
---

{{< youtubeLite id="umXfROcu8FI" label="From Fintech to Energy Abundance" >}}
...
After taking some much-needed time off to recharge and spend time with my family in Canada, I found myself drawn to a new, monumental challenge. I began working closely with 1882 Energy Ventures, the energy venture studio backed by the Aboitiz conglomerate.
...
Of course, we couldn't ignore the elephant in the room: Artificial Intelligence. AI is aggressively driving the cost of software development down to near zero. Because of this, the primary bottleneck for innovation is no longer software; it is hardware and energy.
...
Navigating the "messy middle" of a startup requires a deep understanding of human dynamics. I shared a few frameworks that have guided me:

1.  **Define Your True Core Values:** A [core value]({{< relref "articles/values" >}}) is something that you could legitimately take the opposite stance on, and it is often costly to uphold. It provides your team with a decision heuristic when explicit policies do not exist.
...
{{< faq >}}
{{% faq-item question="What is the connection between energy and GDP?" %}}
...
{{% /faq-item %}}
{{% faq-item question="Why is the cost of software development dropping?" %}}
...
{{% /faq-item %}}
{{% faq-item question="What defines a true core value?" %}}

...
about:
  - name: "Tokenization"
    url: "https://en.wikipedia.org/wiki/Tokenization_(data_security)#Asset_tokenization"
  - name: "Capital market"
    url: "https://en.wikipedia.org/wiki/Capital_market"
mentions:
...
citations:
  - title: "Brian Armstrong Lists 8 Ways Finance Still Needs 'An Update' And Crypto Is At The Center"
    url: "https://www.benzinga.com/markets/tech/26/05/52770225/brian-armstrong-lists-8-ways-finance-still-needs-an-update-and-crypto-is-at-the-center"
  - title: "Crypto and the Evolution of the Capital Markets"
    url: "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5250986"
  - title: "Tokenization: What you need to know"
    url: "https://insightcommunity.mercer.com/api/v1/uploads/Paper_Tokenization_Primer_for_Investors_August_2026_191006d492.pdf"
  ...
  - title: "Smart NAV Pilot Report: Bringing Trusted Data to the Blockchain Ecosystem"
    url: "https://www.dtcc.com/dtcc-connection/articles/2024/may/16/smart-nav-pilot-report-bringing-trusted-data-to-the-blockchain-ecosystem"
  - title: "SIFMA Statement on First Day of T+1 Settlement"
    url: "https://www.sifma.org/news/press-releases/sifma-statement-on-first-day-of-t1-settlement"
  - title: "An Imperative for Growth and the New Economics of Asset Management"
    url: "https://www.bcg.com/publications/2026/an-imperative-for-growth-and-the-new-economics-of-asset-management"
---
...
The SEC staff's January 2026 [statement on tokenized securities](https://www.sec.gov/newsroom/speeches-statements/corp-fin-statement-tokenized-securities-012826-statement-tokenized-securities) is useful because it cuts through a lot of noise. A tokenized security is still a security. The statement separates issuer-sponsored tokenized securities from third-party tokenized products, including custodial and synthetic models. That difference matters because the investor's rights can be very different depending on who created the token, who holds the underlying asset, and what legal claim the token actually represents.
...
1. Who is the issuer or sponsor?
2. What is the legal claim?
3. Where is the authoritative ownership record?
4. What happens if the token and an off-chain record disagree?
5. What money settles the transaction?
6. Who handles custody, KYC, AML, sanctions, tax, and dispute resolution?
7. Can the asset be transferred legally, or only technically?
...
First, stablecoins proved there is demand for internet-native settlement. I have seen the practical side of this before. In [While the West Debated Whitepapers, We Were Shipping Stablecoins]({{< ref "articles/i2i-phx" >}}), I wrote about building PHX and i2i in the Philippines in 2019. The point was not speculation. The point was settlement across fragmented institutions that could not efficiently reach each other.
...
1. **Real friction:** The use case must reduce a current cost, delay, risk, capital charge, or access barrier.
2. **Clear legal claim:** The token must map cleanly to enforceable rights.
3. **Regulated settlement asset:** The cash leg cannot be an afterthought.
4. **Operational governance:** Identity, transfer rules, custody, audit, tax, and dispute handling must be designed upfront.
5. **Network incentive:** Issuers, investors, custodians, banks, brokers, and infrastructure providers must each have a reason to participate.
...
This is the same logic behind [The Future of Finance]({{< ref "articles/future-of-finance" >}}). Embedded, open, and decentralized finance were never separate trends. They are all ways of pushing financial services closer to the underlying economic activity. Tokenization is the asset side of that same shift.
...
{{< faq >}}
  {{% faq-item question="What is tokenization in capital markets?" %}}
  Tokenization is the representation of a financial or real-world asset on programmable rails, where ownership records, transfer logic, compliance controls, and settlement workflows can be handled closer together. A tokenized security is still a security; tokenization changes the infrastructure around the claim, not the economic nature of the claim itself.
  {{% /faq-item %}}
  {{% faq-item question="Why is asset tokenization considered inevitable?" %}}
  Asset tokenization is considered inevitable because capital markets keep paying for fragmented records, delayed settlement, manual reconciliation, and limited collateral mobility. Programmable ownership and settlement can reduce those frictions, especially in debt, funds, repo, private credit, and institutional collateral markets.
  {{% /faq-item %}}
  {{% faq-item question="Will tokenization replace banks, custodians, and exchanges?" %}}
  No. Tokenization will change what banks, custodians, exchanges, transfer agents, and market infrastructure firms do, but it will not remove the need for regulated trust. The likely winners are firms that combine legal authority, settlement access, custody discipline, compliance, and technical execution.
  {{% /faq-item %}}
{{< /faq >}}

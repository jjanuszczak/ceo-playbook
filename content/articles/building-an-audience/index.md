...
about:
  ...
  - name: "Event management"
    url: "https://en.wikipedia.org/wiki/Event_management"
mentions:
  - name: "Rotary International"
    url: "https://en.wikipedia.org/wiki/Rotary_International"
  - name: "Webinar"
    url: "https://en.wikipedia.org/wiki/Web_conferencing"
citations:
  - title: "Key Takeaways from the 2025 Webinar Benchmarks Report"
    url: "https://www.on24.com/blog/key-takeaways-from-the-2025-webinar-benchmarks-report/"
  - title: "The Ubiquitous But Undervalued Value of B2B Events"
    url: "https://www.linkedin.com/business/marketing/blog/research-and-insights/the-undervalued-value-of-b2b-marketing-events"
  - title: "Examining the motivation, perceived performance, and behavioral intentions of convention attendees"
...
The first problem in building an audience is not reach. It is legitimacy.
...
We began with a core group of members, but we did not treat them as a captive audience. We asked them to invite people. We promoted sessions through LinkedIn and Facebook. Over time, the event registrations became a qualified mailing list that could be invited to later events.
...
That same logic shows up in venture building. Early growth depends on doing the work close enough to the customer that you can learn what actually creates pull. I have written before about why [the path to scale requires unscalable work]({{< ref "articles/path-to-scale" >}}). An event series is no different.

## Why should you do the work manually first?

We resisted the urge to put the series immediately onto Eventbrite or another event platform.
...
A personal call does more than remind people. It asks for a decision. "Will you be there?" creates a commitment that an automated confirmation email rarely does. It does not scale forever, but early on, neither does anything worth building. This is the same operating logic behind [responsiveness as a leadership discipline]({{< ref "articles/responsiveness" >}}): when the system is still young, speed and direct contact carry trust.
...
This is also a structural choice. In [corporate venture building]({{< ref "articles/cvc-vs-cvb" >}}), capital should follow proof of a repeatable operating model, not just the ambition to scale. A recurring event series has the same discipline. First prove the room. Then sell the sponsorship.

## What is the real operating model?

An audience is not built through promotion alone. It is built by repeatedly creating a setting that makes the right people think: this was made for me.
...
{{< faq >}}
  {{% faq-item question="How do you start building a professional audience from zero?" %}}
  ...
  {{% /faq-item %}}
  {{% faq-item question="Why should early event operations stay manual?" %}}
  ...
  {{% /faq-item %}}
  {{% faq-item question="What attendance rate should a professional event planner expect?" %}}

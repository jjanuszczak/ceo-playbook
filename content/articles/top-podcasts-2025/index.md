---
title: "Top 10 Podcast Episodes of 2025"
date: 2025-12-28
...
summary: "From the history of the Vikings to the future of the Metaverse, here are the 10 standout podcast episodes that defined my listening year."
tags:
  - Startups
  - Fintech
  - AI
...
My favourite podcast episodes from 2025 featured deep dives into tech giants, historical epics, and masterclasses in business building. 

{{< alert icon="circle-info" >}}
Note that these are my top podcast episodes *listened to* in 2025, even though one or two may have been released prior to 2025.
{{< /alert >}}
...
{{< youtubeLite id="lB95KLmpLR4" label="The Social Network Official Trailer" >}}

The product and technical side of me just really liked the story of how they maintained performance while they scaled in the early days of Facebook’s massive growth:
...
{{< spotify type="episode" id="6nJwfjrv8oxVzr50WmWHv8" >}}

## Acquired: The Google Series
...
I remember when Google search came out (I think I was using AltaVista before that). I was an early [Writely](https://www.failory.com/google/writely) user, a web app that was acquired by Google and ultimately morphed into today’s Google Docs. I have been a user with Google as it navigated (survived?) multiple paradigm shifts (browser, mobile, social) and now AI. It was fitting to better understand Google’s clear advantage in AI, and how they were both early *and late* to it resulting in Google management’s "code red" in December 2022 following the release and popularity of OpenAI's ChatGPT: considered a threat to Google's search engine business and its advertising model.

**The episodes**:

{{< spotify type="episode" id="64V71y4FpMlZ8Mymwu5Xts" >}}
{{< spotify type="episode" id="5WFwfl9N4L5oWZLL9JwMis" >}}
{{< spotify type="episode" id="1WICjyeivPI7KqGFq4zFKe" >}}

## How I Built This: Magnolia
...
I never thought about it this way, but home renovation and construction was a big part of my formative years. When I was young, my family built a sizable addition to our house, and my father did much of the work himself to save money\! I learned so much about the whole process: from framing and insulation to plumbing, electrical, drywall, and tiling. To this day, I still watch countless shows about home and furniture renovation and restoration (the people building off-grid hold a special fascination for me). It was great to listen to this podcast and learn how this subject became such a popular phenomenon. 

Listen to the episode:

{{< spotify type="episode" id="5wk2k4iuQ8sOMG29cheuwm" >}}

## Acquired: Stratechery

Ben Thompson, the author of the influential tech newsletter [Stratechery](https://stratechery.com/), joins the show to discuss his own business journey. They explore the "Aggregation Theory" framework he popularized, the history of the subscription media model he pioneered, and his analysis of the tech industry's shifting landscape. It is a meta-conversation about the business of analyzing business.

As a long-time reader of Stratechery, I’ve always appreciated its deep focus on tech strategy and highly recommend it as a resource. But what was truly fascinating was learning about the *business* of Stratechery: how Ben built his own newsletter tech before viable off-the-shelf solutions existed, the evolution of his platform, and how he successfully monetized it. As a publisher myself, seeing how he took this to the next level is incredibly inspiring and provides super interesting insights.

Listen to the episode:

{{< spotify type="episode" id="6FJhq6E1i1KEP01fY4Bboz" >}}
...
{{< spotify type="episode" id="5PwtWcgg71nSkb63ZV4hGX" >}}

## Invest Like the Best: Bill Gurley
_The Gift and The Curse of Staying Private_
...
Being involved in venture capital investing across Southeast Asia, the issues discussed here hit particularly close to home. In markets with less developed capital, the possibility of exiting through an IPO feels even more distant. That's why we focus so heavily on Distributed to Paid-in (DPI), sometimes even more than Total Value to Paid-in (TVPI), given the real challenges in securing an exit. This episode sparked a thought in my mind about the potential of tokenization to create secondary markets for companies that would otherwise remain strictly private. I’m genuinely excited to see where this goes.

Listen to the episode:

{{< spotify type="episode" id="3coA5PwQ1iz7mMxjctLNCA" >}}
...
Listening to this episode was a perfect follow-up to having read Ben Rich’s [*Skunk Works: A Personal Memoir of My Years of Lockheed*](https://www.amazon.com/Skunk-Works-Personal-Memoir-Lockheed/dp/0316743003) earlier this year. As a designer and operator of corporate innovation programs, I find this story is even more relevant today than it was when Lockheed started the Skunk Works division in 1943\. The author’s own words resonate: 

>“Any company whose fortune depends on developing new technologies should have a Skunk Works in operation.” 

More so than ever before, the future of most companies depends on developing or masterfully using new technologies. 

Listen to the episode:

{{< spotify type="episode" id="7BEVSm4QydO66SEfwiOZQc" >}}

## In Good Company: Nasdaq CEO
_Tech Innovation, Leadership and Fighting Financial Crime_
...
Here is something I did not realize until I met Tal Cohen, Nasdaq President in Manila earlier this year: Nasdaq isn’t just an exchange. It’s really a technology platform company.
...
{{< figure
    src="nasdaq-business-mix.jpeg"
    alt="Nasdaq Business Mix"
    caption="Nasdaq is a technology & platform company"
    >}}
...
{{< spotify type="episode" id="7nBjTYq7fVMwkhMM42skUR" >}}

## The Rest is History: The Last Viking

Episodes: The Last Viking (Parts 1-3)
...
Jeff Bezos once said (on the a16z podcast\!) “There are two kinds of companies, those that work to try to charge more and those that work to charge less.” One model maximizes margins, squeezing as much as it can from each customer. The other minimizes margins, driving scale by charging as little as possible. Don chose the second path, trying to keep the 24oz can under a dollar no matter what.

{{< figure
    src="arizona-cans-ph.jpg"
    alt="AriZona Cans in the Philippines"
    caption="Not quite under a dollar! 102 Philippine Pesos = $1.74 USD"
    >}}

Listen to the episode:

{{< spotify type="episode" id="53BIg3s3U6tSuBD57s8aZD" >}}

## Bonus: The Jamie Dimon Interview
_Live from Radio City Music Hall with Acquired\!_
...
What a come back story\! Great to hear it first hand and with the guys from Acquired.

Listen to the interview:

{{< spotify type="episode" id="3JPOsxy5VY0uFYK2hosrWR" >}}
...
{{< spotify type="episode" id="4jfXVUQzlqw8W05XttdCy2" >}}

## Playlists

If you are on Spotify you can grab the entire playlist here:

{{< spotify type="playlist" id="6irHsqGkhJQJFaVh6T8xCH" >}}

I have done this in previous years too! Here are my top podcast episodes from 2024:

{{< spotify type="playlist" id="1lVyJXKm0mdc9GlyIwqiwW" >}}

And here are my top episodes from 2023:

{{< spotify type="playlist" id="2XFQhPSN7NlrZkXCP0uMEZ" >}}

If you are not on spotify, many of the episodes can be found on YouTube or the podcast shows' websites. 

## Carve Outs

Ironically, Writely was [covered](https://www.acquired.fm/episodes/episode-9-writely-google-docs) in Season 1 of Acquired, which fits nicely into the recent Acquired Holiday Special: **10 Years of Acquired** where Michael Lewis speaks directly to how different the show  was in the first season, focusing on _successful_ acquisitions. It is therefore especially fitting to review it!

{{< spotify type="episode" id="3v6XYuofiZLmITBnlTNgxp" >}}

Secondly, Benchmark (Bill Gurley's firm) was also [featured](https://www.acquired.fm/episodes/benchmark-capital) in 11th season of Acquired. Not a bad way to get you in the mood for the episode in the list above!

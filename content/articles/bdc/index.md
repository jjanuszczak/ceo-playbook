...
summary: >
  ...
  powerful counter-cyclical institutions in the Canadian economy—and the country’s largest venture capital investor.
  This is the story of how a government-owned bank learned to profit from market failure while stabilizing
  innovation, startups, and small businesses through crises.
description: >
  An in-depth look at the Business Development Bank of Canada (BDC): its wartime origins, evolution from
  lender of last resort to complementary lender, governance scars from political scandal, and modern role
  as the largest venture capital investor in Canada. The article explains how BDC arbitrages market failure,
  deploys smart capital, crowds in private investors, and uses a deliberately lower return on equity as a
...
This is the story of a very different kind of "company." It’s a bank, but it’s not really a bank. It’s a venture capitalist, but it’s owned by the government. It is the [Business Development Bank of Canada](https://www.bdc.ca/en), or BDC.
...
1. **Fund of Funds** (The "LP" Business): This is their secret weapon. They invest in other VC funds. If you are a Canadian VC like Panache or Real Ventures, BDC is likely your biggest Limited Partner.
2. **Direct Venture Funds**: This is where they pick stocks themselves. They have specific verticals:
...
3. **Growth Equity**: When companies get too big for VC but aren't ready for an IPO, BDC writes the $20M to $50M checks.
...
| ------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **WINNER**    | **[Verafin](https://verafin.com/)**         | **The Crown Jewel.** A St. John’s-based fraud detection firm acquired by Nasdaq for **$2.75 billion USD** in 2020. Proved multi-billion dollar tech can be built in Atlantic Canada.  |
| **WINNER**    | **[Clio](https://www.clio.com/)**           | **The Growth Anchor.** A legal-tech giant that recently raised at a **$3 billion valuation**. BDC invested heavily in later stages to keep the company independent.                   |
| **WINNER**    | **[Ecobee](https://www.ecobee.com/en-us/)** | **The Nest-Killer.** BDC provided the growth capital that allowed this smart thermostat company to compete with Google until its successful acquisition by Generac.                   |
| **WINNER**    | **[D-Wave](https://www.dwavequantum.com/)** | **The Deep Tech Bet.** A quantum computing pioneer that took decades to mature. BDC stayed the course long after private VCs would have exited, leading to a public listing via SPAC. |
| **WINNER**    | **[Layer 6](https://layer6.ai/)**           | **The Talent Play.** A Toronto AI company acquired by TD Bank in 2018 for a reported **$100 million**, strengthening Canada’s internal banking technology ecosystem.                  |

...
summary: "Argues that AI risks driving banks toward visual and experiential sameness—'AIrSpace'—and challenges leaders to preserve differentiation through vision, brand, and execution."
description: "Builds on the 'AirSpace' idea of cultural homogenization to show how AI could accelerate convergence across banking apps, products, and customer interactions. Warns that using the same data and models will produce similar outputs, and recommends differentiation through strategic choices, distinctive brand, and bold execution rather than reliance on commoditized tools."
categories:
   - "Strategy"
tags:
  - platform-economics
...
I shared the following visual from Digital Banking advisor [David Jimenez Maireles](https://my.linkedin.com/in/davidjimenezmaireles):

{{< figure src="digital-banking-apps.jpg" alt="Digital Banking Apps around the world" caption="Digital Banking Apps around the world. Image source: David Jimenez Maireles" >}}
...
This descent into sameness is not new. Back in 2016, [Kyle Chayka](https://www.linkedin.com/in/kyle-chayka-8b111917)’s essay [AirSpace](https://www.theverge.com/2016/8/3/12325104/airbnb-aesthetic-global-minimalism-startup-gentrification) (published in The Verge) argued that technology was already driving global sameness. Airbnb apartments, coffee shops, co-working spaces, even menus: wherever you traveled, you saw the same white walls, Edison bulbs, succulents, and avocado toast. The internet was flattening culture into a shared aesthetic.
...
Peter Thiel, entrepreneur, venture capitalist, and author best known as a co-founder of [PayPal](https://www.linkedin.com/company/paypal) argues that striving to out-compete in existing markets (i.e. “me-too-ness”) limits value creation. By contrast, the rare companies that carve out new ground (“monopolies” in his sense) succeed by virtue of being unique:
...
{{< button href="/contact" >}}Let's Build What's Next{{< /button >}}

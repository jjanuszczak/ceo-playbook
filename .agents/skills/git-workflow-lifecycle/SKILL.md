...
```bash
python3 .agents/skills/git-workflow-lifecycle/scripts/submit_work.py --message "feat: description of work"
```
...
```bash
python3 .agents/skills/git-workflow-lifecycle/scripts/cleanup_branch.py
```
...
1.  **Run Evaluation Suite:** `python3 .agents/skills/git-workflow-lifecycle/evals/runner.py submit <branch_name>`
...
1.  **Run Evaluation Suite:** `python3 .agents/skills/git-workflow-lifecycle/evals/runner.py cleanup <branch_name>`

...
```bash
uv run python .agents/skills/git-workflow-lifecycle/scripts/submit_work.py --message "feat: description of work"
```
...
```bash
uv run python .agents/skills/git-workflow-lifecycle/scripts/cleanup_branch.py
```
...
1.  **Run Evaluation Suite:** `uv run python .agents/skills/git-workflow-lifecycle/evals/runner.py submit <branch_name>`
2.  **Analyze Report:** Read results in `.agents/skills/git-workflow-lifecycle/evals/reports/latest_submit_results.json`.
...
1.  **Run Evaluation Suite:** `uv run python .agents/skills/git-workflow-lifecycle/evals/runner.py cleanup <branch_name>`
2.  **Analyze Report:** Read results in `.agents/skills/git-workflow-lifecycle/evals/reports/latest_cleanup_results.json`.
...
<AVAILABLE_RESOURCES>
*   **Evaluation Runner:** `.agents/skills/git-workflow-lifecycle/evals/runner.py`
</AVAILABLE_RESOURCES>
